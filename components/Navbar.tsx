                ...
                {[
                  { 
                    ...
                    subItems: [
                      ...
                      { name: 'Maruti Suzuki Ciaz', path: '/fleet/sedans/maruti-suzuki-ciaz' },
                    ]
                  },
                  { 
                    name: 'SUV/MUVs', 
                    path: '/fleet/suv-muvs',
                    subItems: [
                      { name: 'Maruti Suzuki Ertiga', path: '/fleet/suv-muvs/ertiga' },
                      { name: 'Toyota Rumion', path: '/fleet/suv-muvs/rumion' },
                      { name: 'Innova Crysta', path: '/fleet/suv-muvs/innova-crysta' },
                      { name: 'Innova Hycross', path: '/fleet/suv-muvs/innova-hycross' },
                      { name: 'Maruti Suzuki Invicto', path: '/fleet/suv-muvs/invicto' },
                      { name: 'Toyota Fortuner', path: '/fleet/suv-muvs/fortuner' },
                      { name: 'Kia Carnival', path: '/fleet/suv-muvs/carnival' },
                      { name: 'Kia Carens', path: '/fleet/suv-muvs/carens' },
                    ]
                  },
                  ...
                  { 
                    ...
                    subItems: [
                      { name: 'Toyota Camry', path: '/fleet/luxury-cars/camry' },
                      { name: 'Mercedes E-Class', path: '/fleet/luxury-cars/e-class' },
                      ...
                      { name: 'Toyota Vellfire', path: '/fleet/luxury-cars/vellfire' },
                    ]
                  },
                  ...
                  { 
                    ...
                    path: '/fleet/van',
                    subItems: [
                      { name: 'Tempo Traveller 9/12 seater', path: '/fleet/van/tempo-9-12' },
                      { name: 'Tempo Traveller 15 Seater', path: '/fleet/van/tempo-15' },
                      { name: 'Urbania 9/12 Seater', path: '/fleet/van/urbania-9-12' },
                  ...
                  { 
                    ...
                    subItems: [
                      { name: 'Mini Bus Coach', path: '/fleet/buses/mini-coach' },
                      { name: 'Luxury Coach', path: '/fleet/buses/luxury-coach' },
                      { name: 'Scania/Volvo Bus', path: '/fleet/buses/scania-volvo' },
                    ]
                  },
                  ...
                  <div key={item.name} className="relative group/sub">
                    ...
                    >
                      <span className="text-[12px] font-bold text-gray-700 group-hover/item:text-[#EB664E] uppercase tracking-wider">
                        {item.name}
                      </span>
                      <svg className="w-3.5 h-3.5 text-blue-800 group-hover/item:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M10,17L15,12L10,7V17Z" />
                      </svg>
                    </Link>

                    {/* Sub-menu for specific vehicles (e.g., Sedans) */}
                        ...
                        <div className="bg-white rounded-lg shadow-2xl border border-gray-100 py-2">
                          {item.subItems.map((sub) => (
                            <Link
                              key={sub.name}
                              href={sub.path}
                              className="block px-6 py-3 text-[12px] font-bold text-gray-700 hover:text-[#EB664E] hover:bg-gray-50 transition-all uppercase tracking-wider"
                            >
                              {sub.name}
                            </Link>
                          ))}
