          ...
          <div className="relative group cursor-pointer h-full flex items-center">
            ...
            <div className="absolute top-full left-0 w-64 bg-transparent pt-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible translate-y-2 group-hover:translate-y-0 transition-all duration-300 z-[100]">
              <div className="bg-white rounded-lg shadow-2xl border border-gray-100 py-2">
                {[
                  { name: 'Sedans', path: '/fleet/sedans', subItems: [{ name: 'Swift Dzire', path: '/fleet/sedans/swift-dzire' }, { name: 'Hyundai Aura', path: '/fleet/sedans/hyundai-aura' }, { name: 'Honda Amaze', path: '/fleet/sedans/honda-amaze' }, { name: 'Honda City', path: '/fleet/sedans/honda-city' }, { name: 'Maruti Suzuki Ciaz', path: '/fleet/sedans/maruti-suzuki-ciaz' }] },
                  { name: 'SUV/MUVs', path: '/fleet/suv-muvs', subItems: [{ name: 'Maruti Suzuki Ertiga', path: '/fleet/suv-muvs/ertiga' }, { name: 'Toyota Rumion', path: '/fleet/suv-muvs/rumion' }, { name: 'Innova Crysta', path: '/fleet/suv-muvs/innova-crysta' }, { name: 'Innova Hycross', path: '/fleet/suv-muvs/innova-hycross' }, { name: 'Maruti Suzuki Invicto', path: '/fleet/suv-muvs/invicto' }, { name: 'Toyota Fortuner', path: '/fleet/suv-muvs/fortuner' }, { name: 'Kia Carnival', path: '/fleet/suv-muvs/carnival' }, { name: 'Kia Carens', path: '/fleet/suv-muvs/carens' }] },
                  { name: 'Luxury Cars', path: '/fleet/luxury-cars', subItems: [{ name: 'Toyota Camry', path: '/fleet/luxury-cars/camry' }, { name: 'Mercedes E-Class', path: '/fleet/luxury-cars/e-class' }, { name: 'Mercedes S-Class', path: '/fleet/luxury-cars/s-class' }, { name: 'BMW 7 Series', path: '/fleet/luxury-cars/bmw-7' }, { name: 'Jaguar XF', path: '/fleet/luxury-cars/jaguar-xf' }, { name: 'Mercedes Viano', path: '/fleet/luxury-cars/viano' }, { name: 'Land Rover Defender', path: '/fleet/luxury-cars/defender' }, { name: 'Toyota Vellfire', path: '/fleet/luxury-cars/vellfire' }] },
                  { name: 'Van', path: '/fleet/van', subItems: [{ name: 'Tempo Traveller 9/12 seater', path: '/fleet/van/tempo-9-12' }, { name: 'Tempo Traveller 15 Seater', path: '/fleet/van/tempo-15' }, { name: 'Urbania 9/12 Seater', path: '/fleet/van/urbania-9-12' }, { name: 'Urbania 15 Seater', path: '/fleet/van/urbania-15' }] },
                  ...
                  { name: 'Luxury Buses', path: '/fleet/luxury-buses', subItems: [{ name: 'Mini Bus Coach', path: '/fleet/buses/mini-coach' }, { name: 'Luxury Coach', path: '/fleet/buses/luxury-coach' }, { name: 'Scania/Volvo Bus', path: '/fleet/buses/scania-volvo' }] },
                ].map((item) => (
